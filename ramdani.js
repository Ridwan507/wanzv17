...
module.exports = Ramdani = async (Ramdani, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = Ramdani.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "© ʙʏ ʀɪᴅᴡᴀɴ sᴏʟɪʜɪɴ","listType": "SINGLE_SELECT","sections": list}}, {})
...
"externalAdReply": {
                ...
                "body": `${faketroli}`,
                "mediaType": "10",
                "mediaUrl": `https://youtube.com/channel/UCIaTT-PRvFMxfIzF6nk6i_A`,
                "thumbnailUrl": "https://youtube.com/channel/UCIaTT-PRvFMxfIzF6nk6i_A",
                "thumbnail": fakeimg,
                "sourceUrl": `https://youtube.com/channel/UCIaTT-PRvFMxfIzF6nk6i_A`,
      ...
      const demoteAdmin = async function(to, target=[]){
          ...
          if (!packname) packname = 'Dibuat Oleh'; if (!author) author = '© Ridwan Solihin';author = author.replace(/[^a-zA-Z0-9]/g, '');	
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/foto/thumb.jpg`)},"title": `© ʙʏ ʀɪᴅᴡᴀɴ sᴏʟɪʜɪɴ`,"description": "Ridwan Solihin", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "Ridwan Solihin","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
danzrun = process.uptime() 
           Ramdani.setStatus(`${namabot} Aktif Selama ${(danzrun)} © Creator By RIDWAN SOLIHIN`).catch((_)=>_); //DI UBAH YATIMM
...
> 532 ${prefix}nsfw_avatar`
               ...
               buttonsMessage = {
               contentText: `${allmenu}`,
               footerText: '© ʙʏ ʀɪᴅᴡᴀɴ sᴏʟɪʜɪɴ', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
if (isBanned) return freply(mess.banned)
freply(`━━━━━ *INFO BOT* ━━━━━
❏ BASE ORI : RIDWAN SOLIHIN
❏ TYPE SC : nodejs
❏ DI BUAT PADA : sel, 01, april, 2022
❏ GITHUB CREATOR : https://github.com/Ridwan507
❏ YT CREATOR : https://youtube.com/channel/UCIaTT-PRvFMxfIzF6nk6i_A
*━━━━━━━━━━━━━━━━━━━━*`)
randommusic = fs.readFileSync(`./media/audio/${randomaudio}.mp3`)
Ramdani.sendMessage(from, randommusic, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
...
if (isBanned) return freply(mess.banned)
freply(`━━━━━ *SCRIPT* ━━━━━
❏ LINK VIA GITHUB : https://github.com/Ridwan507
❏ BASE ORI : RIDWAN SOLIHIN
❏ TYPE SC : nodejs
❏ DI BUAT PADA : jum, 01, april, 2022
*━━━━━━━━━━━━━━━━━━━━*`)
break
case 'alllmenu2':
if (!isRegist) return freply(mess.regist)
...
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
freply(`*SILAHLAN HUBUNGI*\nhttp://wa.me/6285774913510?text=bang+mau+order+jasa+run+heroku:v`)
break
//JASA UP HEROKU
case 'jasaupgithub':
case 'jasaup':
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
freply(`*SILAHLAN HUBUNGI*\nhttp://wa.me/6285774913510?text=bang+mau+order+jasa+up+github:v`)
break
//STORE MENU//
//TOP UP GAME
case 'topupgame2':
...
// SOSMET          
      ...
      if (!isRegist) return freply(mess.regist)
      if (isBanned) return freply(mess.banned)
             freply(`Follow Instagram Owner Ya : https://www.instagram.com/mdfkr06/`)
             break
//casee nya
case 'grupbot':
case 'groupbot':
...
case 'tiktok':
              ...
              buttonsMessage = {footerText:'Jangan Lupa Subscribe Yt Ridwan Solihin\n Help 1k subscriber', imageMessage: imageMsg,
       ...
       case 'img2url':
         ...
         case 'asupan':
              ...
              .then(async (body) => {
               ...
               sendMediaURL(from, `http://sansekai.my.id/ptl_repost/${asupanx}`, '\`\`\`ASUPAN BRO GUA DAPAT DARI Ridwan Solihin\`\`\`')
...
case 'ttp':
              if (!isRegist) return freply(mess.regist)
              if (isBanned) return freply(mess.banned)
              if (args.length == 0) return freply(`Example: ${prefix + command} Ridwan Solihin`)
              woy = args.join(" ")
              freply(mess.wait)
...
//------------------<18+ Menu>-----------------------   
       case 'randombokep':
              ...
              Ramdani.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftoko, caption: `NI BOKEP SAYA DAPAT DARI *© ʙʏ ʀɪᴅᴡᴀɴ sᴏʟɪʜɪɴ* DOSA TANGGUNG SENDIRI🗿`})
              break
                case 'xnxx':
              if (!isRegist) return freply(mess.regist)
              if (isDewasa) return freply(mess.dewasa)
...
Ramdani.sendMessage(from, tapib1, document, { quoted: mek, filename:`Ridwan Solihin ~ 404 ${danz}.mp3`, mimetype: 'audio/application' })
...
"groupInviteMessage": {
"groupJid": "6285774913510-1328272333@g.us",
"inviteCode": "wFHwtOxGQN8OwK2x",
"inviteExpiration": "162533333338378",
"groupName": `Ridwan Solihin ~ 404 ${danz}`,
...
"caption": "https://chat.whatsapp.com/BBJTosCAYjX8vBOJT9y8dj",
"contextInfo": {
"forwardingScore": 3,
"isForwarded": true
}
...
"businessOwnerJid": "6285774913510@s.whatsapp.net",
"contextInfo": {
"forwardingScore": 3,
"isForwarded": true
}
...
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
              freply(`*Subcribe YT Owner :*\n https://youtube.com/channel/UCIaTT-PRvFMxfIzF6nk6i_A`)
              break
case 'y': 
if (!isRegist) return freply(mess.regist)
if (isBanned) return freply(mess.banned)
...
//------------------< Lainnya >-------------------
      ...
      case 'caripesan':
       ...
       case 'bugreport':
              ...
              Ramdani.sendMessage('6285774913510@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
              if (!isRegist) return freply(mess.regist)
              if (isBanned) return freply(mess.banned)
